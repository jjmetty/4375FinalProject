              ...
              <div class = "row">
                ...
                <div class = "row">
                  ...
                  <div class="form-group col-sm-3 my-1">
                     ...
                     <input type="date" class = "form-control" v-model = "job.requestDate">
                  </div>
               ...
               <div class = "row">
                  ...
                  <div class="form-group col-sm-2 my-1">
                    ...
                    <input type="number" step=0.01 class="form-control" v-model.number = "job.treeTrimmingCost">
                  </div>
                  ...
                  <div class="form-group col-sm-2 my-1">
                    ...
                    <input type="number" step=0.01 class="form-control" v-model.number = "job.stumpGrindingCost">
                  </div>
                 ...
                 <div class = "row">
                  ...
                  <div class="form-group col-sm-2 my-1">
                    ...
                    <input type="number" step=0.01 class="form-control" v-model.number = "job.treeRemovalCost">
                  </div>
                  ...
                  <div class="form-group col-sm-2 my-1">
                    ...
                    <input type="number" step=0.01 class="form-control" v-model.number = "job.treeFertilizationCost">
                  </div>


                 </div>

                <!--<span>Job Charge:  {{job.treeTrimmingCost + job.stumpGrindingCost + job.treeRemovalCost + job.treeFertilizationCost}}</span> -->
